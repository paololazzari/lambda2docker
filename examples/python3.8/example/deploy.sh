...
aws lambda create-function --function-name python38 --zip-file fileb://lambda-package.zip --role "arn:aws:iam::$ACCOUNT_NUMBER:role/lambda-ex" --runtime python3.8 --handler lambda_function.lambda_handler
